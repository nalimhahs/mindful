...
function CustomPageJS() {
    ...
    $(".minileftbar .notifications").on('click',function() {
        $(".right_menu .notif-menu").toggleClass("open").siblings().removeClass('open');
    ...
    $(".minileftbar .task").on('click',function() {
        $(".right_menu .task-menu").toggleClass("open").siblings().removeClass('open');
    ...
    $(".minileftbar .menuapp-btn").on('click',function() {
        $(".right_menu .menu-app").toggleClass("open").siblings().removeClass('open');
    ...
    $(".minileftbar .js-right-sidebar").on('click',function() {
        $(".right_menu #rightsidebar").toggleClass("open").siblings().removeClass('open');
    ...
    $('.minileftbar .bars').on('click',function() {
        $('.right_menu .sidebar').toggleClass("open").siblings().removeClass('open');
        if ($('.right_menu .sidebar').hasClass('open')) {
            $('.overlay').fadeIn();
        } else {
            $('.overlay').fadeOut();
        }
